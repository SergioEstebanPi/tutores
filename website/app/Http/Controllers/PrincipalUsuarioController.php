...
class PrincipalUsuarioController extends Controller
{
    /**
    ...
    public function mis_publicaciones(){
        $publicaciones = \App\Publicacion::where('id', '=', Auth::user()->id)->get();
        return view('publicaciones.index', compact('publicaciones', $publicaciones));
    }

    public function mis_cotizaciones(){
        $cotizaciones = \App\Cotizacion::where('id', '=', Auth::user()->id);
